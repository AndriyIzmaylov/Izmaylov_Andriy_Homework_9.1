...
#
# Вихідні параметри: Словник, у якому ключами є шукані слова та значеннями, скільки разів
# кожнє слово зустрічаються у орігінальному тексті.
#
# Приклад:
def popular_words(text, words):
    list_of_words = text.lower().split()
    return {word: list_of_words.count(word) for word in words}
